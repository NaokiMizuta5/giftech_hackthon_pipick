...
const suggestDataAtom = atom<SuggestData[]>(INITIAL_PLAY_SUGGEST_DATA);
const favoriteDataAtom = atom<SuggestData[]>(INITIAL_PLAY_FAVORITE_DATA);
const doneDataAtom = atom<SuggestData[]>(INITIAL_PLAY_DONE_DATA);
